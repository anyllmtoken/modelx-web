...
function renderHome(): string {
  return [
    ...
    `REST: https://api.anyllmtoken.com/v1/models, /v1/providers, /v1/stats`,
    `MCP: https://api.anyllmtoken.com/mcp (Streamable HTTP, no auth)`,
  ].join("\n");
}
...
function renderCompare(): string {
  return [
    ...
    "",
    "```",
    "GET https://api.anyllmtoken.com/v1/models/compare?ids=openai/gpt-4o,anthropic/claude-sonnet-4-6",
    "```",
    "",
    "Or browse the compare page at https://anyllmtoken.com/compare",
  ].join("\n");
}
...
function renderApiDocs(): string {
  return [
    "# API Reference",
    "",
    "- REST: `https://api.anyllmtoken.com/v1`",
    "- MCP: `https://api.anyllmtoken.com/mcp`",
    "",
    ...
    "",
    "```",
    "claude mcp add ModelX --transport http https://api.anyllmtoken.com/mcp",
    "```",
    "",
    "## MCP Tools",
    "",
...
function renderModel(provider: string, id: string): string | null {
  ...
  lines.push(
    ...
    "",
    "```",
    `GET https://api.anyllmtoken.com/v1/models/${model.provider}/${model.id}`,
    "```",
  );
